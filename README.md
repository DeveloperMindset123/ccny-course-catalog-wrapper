...
[API Documentation](https://docs.rs/ccny-course-catalog/0.1.1/ccny_course_catalog/) : To get better understanding of implementation details.
...
### Getting Help
- If the [API Documentation](https://docs.rs/ccny-course-catalog/0.1.1/ccny_course_catalog/) doesn't help and you happen to be stuck on something, there's also examples within the **bin** folder containing executable code.
